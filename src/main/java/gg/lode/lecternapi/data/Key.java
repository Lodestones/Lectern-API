...
/**
 * Java enum mapping Windows Virtual-Key codes to descriptive names.
 * Extracted from Microsoft Learn Virtual-Key Codes documentation.
 * Source: <a href="https://learn.microsoft.com/en-us/windows/win32/inputdev/virtual-key-codes">virtual key codes</a>
 */
public enum Key {
    ...
    KEY_Y(0x59, "Y key"),
    KEY_Z(0x5A, "Z key"),
    KEY_LWIN(0x5B, "Left Windows logo key"),
    KEY_RWIN(0x5C, "Right Windows logo key"),
    KEY_APPS(0x5D, "Application key"),
    ...
    KEY_LCONTROL(0xA2, "Left Ctrl key"),
    KEY_RCONTROL(0xA3, "Right Ctrl key"),
    ...
    KEY_OEM_1(0xBA, "';:' key (misc)"),
    KEY_OEM_PLUS(0xBB, "+ key (misc)"),
    KEY_OEM_COMMA(0xBC, ", key (misc)"),
    KEY_OEM_MINUS(0xBD, "- key (misc)"),
    KEY_OEM_PERIOD(0xBE, ". key (misc)"),
    KEY_OEM_2(0xBF, "/? key (misc)"),
    KEY_OEM_3(0xC0, "`~ key (misc)"),
    KEY_OEM_4(0xDB, "[{ key (misc)"),
    KEY_OEM_5(0xDC, "\\| key (misc)"),
    KEY_OEM_6(0xDD, "]} key (misc)"),
    KEY_OEM_7(0xDE, "'\" key (misc)"),
    KEY_OEM_8(0xDF, "Misc OEM key"),
    KEY_OEM_102(0xE2, "<> or \\| key (misc)"),
    KEY_PROCESSKEY(0xE5, "IME PROCESS key"),
    KEY_PACKET(0xE7, "Unicode packet"),
    ...
    public static @Nullable Key fromKeyCode(int keyCode) {
    ...
    /**
     * Returns the typical label as printed on a standard keyboard, or null if not applicable.
     */
    public @Nullable String simpleLabel() {
        return switch (this) {
            case KEY_LBUTTON -> "LMB";
            case KEY_RBUTTON -> "RMB";
            case KEY_MBUTTON -> "MMB";
            case KEY_XBUTTON1 -> "MB1";
            case KEY_XBUTTON2 -> "MB2";
            case KEY_0 -> "0";
            case KEY_1 -> "1";
            case KEY_2 -> "2";
            case KEY_3 -> "3";
            ...
            case KEY_SPACE -> " ";
            case KEY_TAB -> "TAB";
            case KEY_SHIFT, KEY_LSHIFT, KEY_RSHIFT -> "SHIFT";
            case KEY_CONTROL, KEY_LCONTROL, KEY_RCONTROL -> "CTRL";
            case KEY_MENU, KEY_LMENU, KEY_RMENU -> "ALT";
            case KEY_ESCAPE -> "ESC";
